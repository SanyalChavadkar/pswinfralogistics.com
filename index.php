...
<html lang="en">
   <head>
      ...
      <meta property="og:title" content="Home | PSW">
   ...
   <body>
      ...
      <div class="main-wrapper position-relative">
         <section class="sectionf vh100 position-relative" id="banner">
                  ...
                  <div class="col-md-12 p-0">
                     <div class="section-fifty">
                        ...
                        <div class="big-img vh100 mid-line bg-accentblue">
                           <img src="images/banner.webp" class="w-100 img-fluid" alt="About us">
                        </div>
                     </div>
                  </div>
               </div>
            </div>
            <a href="#services" id="scrollbown" title="Scroll Down">&nbsp;</a>
         </section>
         <section class="sectionf vh100" id="services">
            <div class="container-fluid">
               <div class="row p-0">
                  <div class="col-md-12 p-0">
                     <div class="section-fifty">
                        <div class="left-sec">
                           ...
                           <div class="nav-box">
                              <ul class="nav nav-tabs d-none d-md-block border-0" id="myTab" role="tablist">
                                 ...
                                 <li class="nav-item" role="presentation">
                                    <a class="nav-link f-semibold" data-bs-toggle="tab" href="#man-power-supply" role="tab">Man Power Supply <img src="images/service_arrow_red.svg" class="img-fluid" alt="arrow icon"></a>
                                 </li>
                              </ul>
                           </div>
                                    ...
                                    <div class="accordion-body">
                                       ...
                                       <a href="services.php#road-transportation" class="common-btn btn-outline-white">learn more
                                          <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             ...
                                             <g mask="url(#mask0_3013_272)">
                                                <path d="M17.127 13.8879H5V12.3627H17.127L11.4308 6.57051L12.5 5.49902L20 13.1253L12.5 20.7515L11.4308 19.6801L17.127 13.8879Z" fill="#FCFCFC"/>
                                             </g>
                                          </svg>
                                       </a>
                                    </div>
         ...
         <section class="sectionf vh100" id="about">
            <div class="container-fluid">
               <div class="row p-0">
                  <div class="col-md-12 p-0">
                     <div class="section-fifty">
                        <div class="left-sec">
                           <div class="section-title">
                              <h3 class="subheading">who we are?</h3>
         ...
         <section class="sectionf vh100" id="why">
            <div class="container-fluid">
               <div class="row p-0">
                  <div class="col-md-12 p-0">
                     <div class="section-fifty">
         ...
         <section class="sectionf vh100" id="message">
            <div class="container-fluid">
               <div class="row p-0">
                  <div class="col-md-12 p-0">
                     <div class="section-fifty">
                        <div class="left-sec">
                           ...
                           <div class="message-div">
                              <form action="" method="post" id="contact-form">
                                 ...
                                 <div class="form-group">
                                    <button type="submit" name="homesubmit" class="common-btn w-100" id="form-submit">Send Message</button>
                                 </div>
                              </form>
                           </div>
                        </div>
